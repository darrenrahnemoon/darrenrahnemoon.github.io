...
<template>
	...
	<div class="surface-700 grid">
		...
		<div v-for="feature in features" :key="feature.title" class="col-4 p-4">
			<Card class="h-full">
				<template #header>
					<div class="text-center pt-6">
						<span :class="feature.icon" class="text-7xl" />
					</div>
				</template>
				<template #title>
				...
				<template #content>
					<div class="text-sm line-height-4">
						{{ feature.content }}
					</div>
				</template>
			</Card>
	...
	<div class="text-center p-5 surface-800">
