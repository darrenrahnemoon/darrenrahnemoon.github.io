...
var speedDialItems = [
    {
        label: 'Home',
        icon: 'pi pi-home',
        command: function () { return router.push('/'); },
    },
    {
        label: 'Journey',
        icon: 'pi pi-forward',
        command: function () { return router.push('/journey'); },
    },
    {
        label: 'Projects',
        icon: 'pi pi-wrench',
        command: function () { return router.push('/projects'); },
    },
    {
        label: 'Gallery',
        icon: 'pi pi-images',
        command: function () { return router.push('/gallery'); },
    },
    {
        label: 'Rants',
        icon: 'pi pi-comments',
        command: function () { return router.push('/rants'); },
    },
];
onMounted(function () {
    for (var _i = 0, _a = logo.value.children; _i < _a.length; _i++) {
        var path = _a[_i];
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "menu-mobile flex sm:hidden" }));
var __VLS_0 = {}.SpeedDial;
/** @type {[typeof __VLS_components.SpeedDial, ]} */ ;
// @ts-ignore
var __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0(__assign(__assign({ model: (__VLS_ctx.speedDialItems) }, { class: "right-0 bottom-0" }), { direction: "up", buttonClass: "p-button-sm", tooltipOptions: ({ position: 'left', event: undefined }) })));
var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign(__assign({ model: (__VLS_ctx.speedDialItems) }, { class: "right-0 bottom-0" }), { direction: "up", buttonClass: "p-button-sm", tooltipOptions: ({ position: 'left', event: undefined }) })], __VLS_functionalComponentArgsRest(__VLS_1), false));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "menu hidden sm:flex" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div)(__assign({ class: "menu-line" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "menu-items" }));
var __VLS_4 = {}.RouterLink;
/** @type {[typeof __VLS_components.RouterLink, typeof __VLS_components.routerLink, typeof __VLS_components.RouterLink, typeof __VLS_components.routerLink, ]} */ ;
// @ts-ignore
var __VLS_5 = __VLS_asFunctionalComponent(__VLS_4, new __VLS_4(__assign({ class: "menu-item left" }, { to: "/journey" })));
var __VLS_6 = __VLS_5.apply(void 0, __spreadArray([__assign({ class: "menu-item left" }, { to: "/journey" })], __VLS_functionalComponentArgsRest(__VLS_5), false));
__VLS_7.slots.default;
var __VLS_7;
var __VLS_8 = {}.RouterLink;
/** @type {[typeof __VLS_components.RouterLink, typeof __VLS_components.routerLink, typeof __VLS_components.RouterLink, typeof __VLS_components.routerLink, ]} */ ;
// @ts-ignore
var __VLS_9 = __VLS_asFunctionalComponent(__VLS_8, new __VLS_8(__assign({ class: "menu-item left" }, { to: "/projects" })));
var __VLS_10 = __VLS_9.apply(void 0, __spreadArray([__assign({ class: "menu-item left" }, { to: "/projects" })], __VLS_functionalComponentArgsRest(__VLS_9), false));
__VLS_11.slots.default;
var __VLS_11;
var __VLS_12 = {}.RouterLink;
/** @type {[typeof __VLS_components.RouterLink, typeof __VLS_components.routerLink, typeof __VLS_components.RouterLink, typeof __VLS_components.routerLink, ]} */ ;
// @ts-ignore
var __VLS_13 = __VLS_asFunctionalComponent(__VLS_12, new __VLS_12(__assign({ class: "menu-signature" }, { to: "/" })));
var __VLS_14 = __VLS_13.apply(void 0, __spreadArray([__assign({ class: "menu-signature" }, { to: "/" })], __VLS_functionalComponentArgsRest(__VLS_13), false));
__VLS_15.slots.default;
__VLS_asFunctionalElement(__VLS_intrinsicElements.svg, __VLS_intrinsicElements.svg)(__assign(__assign({ ref: "logo", height: "100%", 'stroke-miterlimit': "10" }, { style: {} }), { version: "1.1", viewBox: "0 0 300 160", width: "100%", 'xml:space': "preserve", xmlns: "http://www.w3.org/2000/svg", 'xmlns:xlink': "http://www.w3.org/1999/xlink" }));
/** @type {typeof __VLS_ctx.logo} */ ;
...
/** @type {[typeof __VLS_components.RouterLink, typeof __VLS_components.routerLink, typeof __VLS_components.RouterLink, typeof __VLS_components.routerLink, ]} */ ;
// @ts-ignore
var __VLS_17 = __VLS_asFunctionalComponent(__VLS_16, new __VLS_16(__assign({ class: "menu-item right" }, { to: "/gallery" })));
var __VLS_18 = __VLS_17.apply(void 0, __spreadArray([__assign({ class: "menu-item right" }, { to: "/gallery" })], __VLS_functionalComponentArgsRest(__VLS_17), false));
__VLS_19.slots.default;
var __VLS_19;
var __VLS_20 = {}.RouterLink;
/** @type {[typeof __VLS_components.RouterLink, typeof __VLS_components.routerLink, typeof __VLS_components.RouterLink, typeof __VLS_components.routerLink, ]} */ ;
// @ts-ignore
var __VLS_21 = __VLS_asFunctionalComponent(__VLS_20, new __VLS_20(__assign({ class: "menu-item right" }, { to: "/rants" })));
var __VLS_22 = __VLS_21.apply(void 0, __spreadArray([__assign({ class: "menu-item right" }, { to: "/rants" })], __VLS_functionalComponentArgsRest(__VLS_21), false));
__VLS_23.slots.default;
var __VLS_23;
/** @type {__VLS_StyleScopedClasses['menu-mobile']} */ ;
...
/** @type {__VLS_StyleScopedClasses['menu-line']} */ ;
/** @type {__VLS_StyleScopedClasses['menu-items']} */ ;
/** @type {__VLS_StyleScopedClasses['menu-item']} */ ;
/** @type {__VLS_StyleScopedClasses['left']} */ ;
/** @type {__VLS_StyleScopedClasses['menu-item']} */ ;
/** @type {__VLS_StyleScopedClasses['left']} */ ;
/** @type {__VLS_StyleScopedClasses['menu-signature']} */ ;
/** @type {__VLS_StyleScopedClasses['menu-item']} */ ;
